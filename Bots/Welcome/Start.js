...
for (let index = 0; index < takachicim.Welcome.Tokens.length; index++) {
    let token = takachicim.Welcome.Tokens[index]
    let channel = takachicim.Welcome.Channels < 1 ? takachicim.Welcome.Channels[0] : takachicim.Welcome.Channels[index]
    if(channel) {
        let client = new ozi()
            ...
            cron.schedule('* * * * 5', () => {
                ...
                if (day === 5) {
                    client.guilds.cache.forEach(async (guild) => {
                        ...
                        await Database.findOneAndUpdate({ guildID: takachicim.GuildID }, {SesMod: xd}, { upsert: true })
                    ...
                    client.guilds.cache.forEach(async (guild) => {
                        ...
                        await Database.findOneAndUpdate({ guildID: takachicim.GuildID }, {SesMod: xd2}, { upsert: true })
