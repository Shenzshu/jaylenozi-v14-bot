...
new ButtonBuilder().setCustomId("sonra").setLabel("Sonraki Sayfa").setStyle(ButtonStyle.Success).setEmoji("⏭️"),
   ...
   if(button.customId === "önce") {
    await button.deferUpdate();
                ...
                msg.edit({ embeds: [new EmbedBuilder() .setDescription(`${isimlerVeri}`).setTimestamp().setAuthor({ name: `${member.user.displayName} üyesinin isim bilgileri;` })]});
            }
