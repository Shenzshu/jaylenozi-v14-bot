...
const applyText = (canvas, text) => {
      ...
      let background = await Canvas.loadImage(client.guilds.cache.get(takachicim.GuildID).bannerURL({dynamic: true, extension: "png"}) ? client.guilds.cache.get(takachicim.GuildID).bannerURL({dynamic: true, extension: "png"}) + `?size=4096` : "https://cdn.discordapp.com/attachments/938786568175513660/970470122806472785/sex.png");
    ...
    let nickname = `[${member ? member.user.tag : member.user.displayName}](https://discord.com/users/${member.user.id})`
