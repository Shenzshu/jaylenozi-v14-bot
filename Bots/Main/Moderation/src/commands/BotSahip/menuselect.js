...
module.exports = {
  ...
  run: async (client, message, args, durum, kanal) => {
    ...
    **NOT:** \`Kayıtlı, kayıtsız olarak hepiniz bu kanalı görebilmektesiniz. Sunucumuz da everyone veya here atılmayacağından dolayı kesinlikle rollerinizi almayı unutmayın.\``,
    ...
    const member = await client.guilds.cache.get(takachicim.GuildID).members.fetch(interaction.member.user.id)
    if (!member) return;
    
    const etkinlik = await client.guilds.cache.get(takachicim.GuildID).roles.cache.find(x => x.name.includes(ayar.etkinlik))
    const cekilis = await client.guilds.cache.get(takachicim.GuildID).roles.cache.find(x => x.name.includes(ayar.cekilis))
    ...
    const koç = await client.guilds.cache.get(takachicim.GuildID).roles.cache.find(x => x.name.includes(ayar.Burçlar.koç))
    const boğa = await client.guilds.cache.get(takachicim.GuildID).roles.cache.find(x => x.name.includes(ayar.Burçlar.boğa))
    const ikizler = await client.guilds.cache.get(takachicim.GuildID).roles.cache.find(x => x.name.includes(ayar.Burçlar.ikizler))
    const yengeç = await client.guilds.cache.get(takachicim.GuildID).roles.cache.find(x => x.name.includes(ayar.Burçlar.yengeç))
    const aslan = await client.guilds.cache.get(takachicim.GuildID).roles.cache.find(x => x.name.includes(ayar.Burçlar.aslan))
    const başak = await client.guilds.cache.get(takachicim.GuildID).roles.cache.find(x => x.name.includes(ayar.Burçlar.başak))
    const terazi = await client.guilds.cache.get(takachicim.GuildID).roles.cache.find(x => x.name.includes(ayar.Burçlar.terazi))
    const akrep = await client.guilds.cache.get(takachicim.GuildID).roles.cache.find(x => x.name.includes(ayar.Burçlar.akrep))
    const yay = await client.guilds.cache.get(takachicim.GuildID).roles.cache.find(x => x.name.includes(ayar.Burçlar.yay))
    const oğlak = await client.guilds.cache.get(takachicim.GuildID).roles.cache.find(x => x.name.includes(ayar.Burçlar.oğlak))
    const kova = await client.guilds.cache.get(takachicim.GuildID).roles.cache.find(x => x.name.includes(ayar.Burçlar.kova))
    const balık = await client.guilds.cache.get(takachicim.GuildID).roles.cache.find(x => x.name.includes(ayar.Burçlar.balık))
    ...
    const csgo = await client.guilds.cache.get(takachicim.GuildID).roles.cache.find(x => x.name.includes(ayar.Oyunlar.csgo))
    const lol = await client.guilds.cache.get(takachicim.GuildID).roles.cache.find(x => x.name.includes(ayar.Oyunlar.lol))
    const valorant = await client.guilds.cache.get(takachicim.GuildID).roles.cache.find(x => x.name.includes(ayar.Oyunlar.valorant))
    const gta5 = await client.guilds.cache.get(takachicim.GuildID).roles.cache.find(x => x.name.includes(ayar.Oyunlar.gta5))
    const pubg = await client.guilds.cache.get(takachicim.GuildID).roles.cache.find(x => x.name.includes(ayar.Oyunlar.pubg))
    const fortnite = await client.guilds.cache.get(takachicim.GuildID).roles.cache.find(x => x.name.includes(ayar.Oyunlar.fortnite))
    ...
    const kirmizi = await client.guilds.cache.get(takachicim.GuildID).roles.cache.find(x => x.name.includes(ayar.Renkler.kirmizi))
    const turuncu = await client.guilds.cache.get(takachicim.GuildID).roles.cache.find(x => x.name.includes(ayar.Renkler.turuncu))
    const mor = await client.guilds.cache.get(takachicim.GuildID).roles.cache.find(x => x.name.includes(ayar.Renkler.mor))
    const pembe = await client.guilds.cache.get(takachicim.GuildID).roles.cache.find(x => x.name.includes(ayar.Renkler.pembe))
    const yesil = await client.guilds.cache.get(takachicim.GuildID).roles.cache.find(x => x.name.includes(ayar.Renkler.yesil))
    ...
    const sevgili = await client.guilds.cache.get(takachicim.GuildID).roles.cache.find(x => x.name.includes(ayar.İlişkiler.couple))
    const yalnız = await client.guilds.cache.get(takachicim.GuildID).roles.cache.find(x => x.name.includes(ayar.İlişkiler.alone))
