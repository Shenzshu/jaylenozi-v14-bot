    ...
    collector.on("collect", async (menu) => {
        ...
        if (menu.customId == "allres") {
            ...
            if(takachicim.Destek.Active) {
                children.exec(`pm2 restart ${takachicim.GuildName}_Destek`);
            }
            if(takachicim.Welcome.Active) {
                children.exec(`pm2 restart ${takachicim.GuildName}_Welcomes`);
            }
            children.exec(`pm2 restart ${takachicim.GuildName}_Voucher ${takachicim.GuildName}_Statistics ${takachicim.GuildName}_Guard_I ${takachicim.GuildName}_Guard_II ${takachicim.GuildName}_Guard_III ${takachicim.GuildName}_Moderation`);
        }
    });
