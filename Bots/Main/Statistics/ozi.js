...
client
  .login(takachicim.Main.StatsToken)
...
client.checkLevel = async function (userID, guildID, type) {
  if (takachicim.Main.LevelSystem == false) return;
  ...
  let member = client.guilds.cache.get(takachicim.GuildID).members.cache.get(userID)
